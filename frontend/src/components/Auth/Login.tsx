...
const Login = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (success) {
      ...
      setError('User not found. Please check your username or create an account.');
      setIsLoading(false);
    }
  };
        ...
        <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl shadow-2xl overflow-hidden">
          <div className="p-8 space-y-8">
            <div className="text-center space-y-2">
              ...
              <p className="text-slate-300 text-sm">Enter your username to access your workspace</p>
            </div>
          ...
          <div className="px-8 py-4 bg-slate-900/50 border-t border-white/10 text-center">
            <p className="text-sm text-slate-400">
              ...
              <Link to="/create-account" className="text-emerald-400 hover:text-emerald-300 font-medium hover:underline transition-colors">
                Create Account
              </Link>
            </p>
          </div>
