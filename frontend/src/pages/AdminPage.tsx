...
import { fetchUsers, fetchEditHistory, type User, type EditHistory } from '@/utils';
import { 
  Shield, 
  Users, 
  Database, 
        ...
        <div className="container mx-auto px-6 py-4 max-w-7xl">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <button className="flex items-center gap-2 px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition-all shadow-sm hover:shadow text-sm font-medium">
                <Download size={16} />
                Export Report
              </button>
            </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden min-h-[600px] flex flex-col">
            ...
            <div className="flex items-center gap-3 w-full md:w-auto">
              ...
              <div className="relative flex-1 md:w-64">
                ...
                <input
                  ...
                  className="w-full pl-9 pr-4 py-2 bg-white border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 focus:outline-none transition-all"
                />
              </div>
                            ...
                            <div key={item.id} className="group bg-white rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-all overflow-hidden flex flex-col">
                              <div className="relative aspect-[2/1] bg-gray-100 flex">
                                ...
                                <div className="flex-1 relative group/output">
                                  ...
                                  <div className="absolute top-2 right-2 bg-indigo-600/90 backdrop-blur-sm text-white text-[10px] px-2 py-0.5 rounded-full shadow-sm pointer-events-none z-20">
                                    Result
                                  </div>
                                </div>
                              </div>
          ...
          <div className="p-4 border-t border-gray-200 bg-gray-50/50 flex items-center justify-between">
            <span className="text-sm text-gray-500">
              Showing <span className="font-medium text-gray-900">1</span> to <span className="font-medium text-gray-900">{activeTab === 'users' ? filteredUsers.length : filteredHistory.length}</span> of <span className="font-medium text-gray-900">{activeTab === 'users' ? users.length : history.length}</span> results
            </span>
